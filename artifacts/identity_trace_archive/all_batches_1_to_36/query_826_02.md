...
What is the title of the only nonfiction work by an author (born 1930-1940) whose works focus on the magical aspects of literature, who studied sciences at a government institution, served in the military during unrest, had a science fiction book before 2020, had a pre-1970 first novel that became a set text, and was once captured and rescued hours later?
...
```json
{
    "user_query": "What is the title of the only nonfiction work by an author (born 1930-1940) whose works focus on the magical aspects of literature, who studied sciences at a go"
}
```
