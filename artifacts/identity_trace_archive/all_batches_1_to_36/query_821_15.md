...
Per the company blog post referenced in a 2020-2023 article (updated 29 minutes later) on a withdrawn-job-offer lawsuit, what percentage of employees recommend the company as a workplace? The company offered a sign-on bonus later that year.
...
```json
{
    "user_query": "Per the company blog post referenced in a 2020-2023 article (updated 29 minutes later) on a withdrawn-job-offer lawsuit, what percentage of employees recommend"
}
```
