...
An article published between 2020 and 2023 and updated 29 minutes later reported a lawsuit over a withdrawn job offer, linked to a same-day company blog post; later that year the company offered a sign-on bonus. What percentage of employees recommend the company as a workplace, per the blog post?
...
```json
{
    "user_query": "An article published between 2020 and 2023 and updated 29 minutes later reported a lawsuit over a withdrawn job offer, linked to a same-day company blog post; l"
}
```
