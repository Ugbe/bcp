...
Name the band (formed 1970-1990) created by a musician who: played in a 100M+-selling rock band; began performing professionally as a teen; married three times; one son and one daughter; attended art college; worked in a boutique.
...
```json
{
    "user_query": "Name the band (formed 1970-1990) created by a musician who: played in a 100M+-selling rock band; began performing professionally as a teen; married three times;"
}
```
