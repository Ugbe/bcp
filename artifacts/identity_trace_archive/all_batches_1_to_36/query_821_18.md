...
Combine the clues — 2020-2023 article updated 29 minutes later; withdrawn-job-offer lawsuit; same-day company blog post; later sign-on bonus — to identify the company, then state the percentage of employees who recommend it as a workplace from the blog post.
...
```json
{
    "user_query": "Combine the clues — 2020-2023 article updated 29 minutes later; withdrawn-job-offer lawsuit; same-day company blog post; later sign-on bonus — to identify the c"
}
```
