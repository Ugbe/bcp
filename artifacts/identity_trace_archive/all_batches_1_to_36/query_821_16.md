...
Use the article details (2020-2023, updated 29 minutes later, withdrawn-job-offer lawsuit, same-day blog-post link, later sign-on bonus) to identify the company, then read the blog post to give the percentage of employees who recommend it as a workplace.
...
```json
{
    "user_query": "Use the article details (2020-2023, updated 29 minutes later, withdrawn-job-offer lawsuit, same-day blog-post link, later sign-on bonus) to identify the company"
}
```
