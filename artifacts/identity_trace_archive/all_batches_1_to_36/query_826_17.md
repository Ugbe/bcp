...
Reason from the pre-1970 first novel that became a set text and the science fiction book before 2020, cross-checked with the magical-literature focus, the government-institution science studies, the military service during unrest, and the abduction-and-rescue, to name the author's only nonfiction work.
...
```json
{
    "user_query": "Reason from the pre-1970 first novel that became a set text and the science fiction book before 2020, cross-checked with the magical-literature focus, the gover"
}
```
