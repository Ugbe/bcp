...
Name the only nonfiction work of the author (born between 1930 and 1940) whose writing centers on the magical aspects of literature, who studied sciences at a government institution, served during a period of unrest, released a science fiction book before 2020, had a first novel (pre-1970) that became a set text, and was once captured then rescued hours later.
...
```json
{
    "user_query": "Name the only nonfiction work of the author (born between 1930 and 1940) whose writing centers on the magical aspects of literature, who studied sciences at a g"
}
```
