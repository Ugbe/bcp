...
Narrow using the article profile (2020-2023, 29-minute update, withdrawn-job-offer lawsuit, same-day blog-post link, later sign-on bonus) to identify the company, then give the percentage of employees recommending it as a workplace from the blog post.
...
```json
{
    "user_query": "Narrow using the article profile (2020-2023, 29-minute update, withdrawn-job-offer lawsuit, same-day blog-post link, later sign-on bonus) to identify the compan"
}
```
