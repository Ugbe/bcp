...
Author (born 1930-1940); works on the magical aspects of literature; sciences at a government institution; military service during unrest; sci-fi book before 2020; pre-1970 first novel a set text; once captured and rescued hours later; only one nonfiction work. Name that work.
...
```json
{
    "user_query": "Author (born 1930-1940); works on the magical aspects of literature; sciences at a government institution; military service during unrest; sci-fi book before 20"
}
```
