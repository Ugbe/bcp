...
```json
{
    "user_query": "Identify the sole nonfiction work of an author born 1930-1940 known for works on the magical aspects of literature, who pursued sciences at a government institu"
}
```
