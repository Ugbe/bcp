...
What percentage of employees recommend the company as a workplace, as stated in a same-day blog post linked from a 2020-2023 article (updated 29 minutes later) that reported a withdrawn-job-offer lawsuit? The company later offered a sign-on bonus that year.
...
```json
{
    "user_query": "What percentage of employees recommend the company as a workplace, as stated in a same-day blog post linked from a 2020-2023 article (updated 29 minutes later)"
}
```
