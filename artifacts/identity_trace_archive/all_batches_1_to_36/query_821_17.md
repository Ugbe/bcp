...
Reason from the withdrawn-job-offer lawsuit article (2020-2023, updated 29 minutes later) and the same-day blog-post link, plus the later sign-on bonus, to identify the company, then give the percentage of employees recommending it as a workplace from the blog post.
...
```json
{
    "user_query": "Reason from the withdrawn-job-offer lawsuit article (2020-2023, updated 29 minutes later) and the same-day blog-post link, plus the later sign-on bonus, to iden"
}
```
