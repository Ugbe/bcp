...
Give the title of the only nonfiction work by an author (born between 1930 and 1940) whose works explore the magical aspects of literature, who studied sciences at a government institution, served in the military during unrest, released a science fiction book before 2020, had a pre-1970 debut novel that became a set text, and was once abducted and rescued within hours.
...
```json
{
    "user_query": "Give the title of the only nonfiction work by an author (born between 1930 and 1940) whose works explore the magical aspects of literature, who studied sciences"
}
```
