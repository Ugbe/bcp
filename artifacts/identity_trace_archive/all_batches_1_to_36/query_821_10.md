...
Per the company blog post linked from an article (2020-2023, updated 29 minutes later) reporting a withdrawn-job-offer lawsuit, what percentage of employees recommend the company as a workplace? Later that year the company offered a sign-on bonus.
...
```json
{
    "user_query": "Per the company blog post linked from an article (2020-2023, updated 29 minutes later) reporting a withdrawn-job-offer lawsuit, what percentage of employees rec"
}
```
