...
Which percentage of employees recommend the company as a workplace, per the blog post linked in a 2020-2023 article (updated 29 minutes later) reporting a withdrawn-job-offer lawsuit, with the company later offering a sign-on bonus that year?
...
```json
{
    "user_query": "Which percentage of employees recommend the company as a workplace, per the blog post linked in a 2020-2023 article (updated 29 minutes later) reporting a withd"
}
```
