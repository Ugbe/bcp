...
An artist (mass-appeal + 'hypnotic' styles; alternative careers computer engineer or math teacher; March 1, 2014 performance before 25000+ with six other artists; youngest of four siblings) described their sound in five words, one a food item, in an October 17, 2013 interview. List those words in order.
...
```json
{
    "user_query": "An artist (mass-appeal + 'hypnotic' styles; alternative careers computer engineer or math teacher; March 1, 2014 performance before 25000+ with six other artist"
}
```
