...
Identify the band formed between 1970 and 1990 by a musician matching: played in a 100M+-selling rock band; began performing professionally in their teens; married three times; one daughter and one son; attended art college; worked in a boutique.
...
```json
{
    "user_query": "Identify the band formed between 1970 and 1990 by a musician matching: played in a 100M+-selling rock band; began performing professionally in their teens; marr"
}
```
