...
Use the 2020 collaboration with a North London rapper (debut mixtape same year) and the friend's lockdown-year equipment loss (manager encouraged them) to identify the artist, cross-checking the country (shared with an early-2000s World Cup runner-up and 2013 Coppa Italia winner) and the yearly one-month release pattern tied to a life-threatening illness. What is the artist's name?
...
```json
{
    "user_query": "Use the 2020 collaboration with a North London rapper (debut mixtape same year) and the friend's lockdown-year equipment loss (manager encouraged them) to ident"
}
```
