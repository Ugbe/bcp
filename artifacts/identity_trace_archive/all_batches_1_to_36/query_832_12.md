...
An international cup league decider (pre-2023) with 4 goals, 2-goal difference, 38 fouls, most goals in the first half (one penalty, one stoppage-time), saw the match winner lose the aggregate by one goal. Name the aggregate-losing captain and the century their club was founded.
...
```json
{
    "user_query": "An international cup league decider (pre-2023) with 4 goals, 2-goal difference, 38 fouls, most goals in the first half (one penalty, one stoppage-time), saw the"
}
```
