...
Which artist, from the country of an early-2000s World Cup runner-up and 2013 Coppa Italia-winning footballer, collaborated in 2020 with a North London rapper (debut mixtape same year)? Their friend lost equipment in the lockdown year (manager said to persist), and the artist releases music in one month each year following a life-threatening illness in that month.
...
```json
{
    "user_query": "Which artist, from the country of an early-2000s World Cup runner-up and 2013 Coppa Italia-winning footballer, collaborated in 2020 with a North London rapper ("
}
```
