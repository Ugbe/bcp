...
Narrow using the decider profile (4 goals, 2-goal difference, 38 fouls, first-half penalty and stoppage-time goal) and the match-winner-lost-aggregate-by-one detail, then name the aggregate-losing captain and their club's founding century.
...
```json
{
    "user_query": "Narrow using the decider profile (4 goals, 2-goal difference, 38 fouls, first-half penalty and stoppage-time goal) and the match-winner-lost-aggregate-by-one de"
}
```
