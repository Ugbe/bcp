...
What percentage of employees recommend the company as a workplace, according to a same-day blog post linked from an article (published 2020-2023, updated 29 minutes later) that reported a lawsuit over a withdrawn job offer, where the company later that year offered a sign-on bonus?
...
```json
{
    "user_query": "What percentage of employees recommend the company as a workplace, according to a same-day blog post linked from an article (published 2020-2023, updated 29 min"
}
```
