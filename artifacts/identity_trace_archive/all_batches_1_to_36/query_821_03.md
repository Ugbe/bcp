...
Per the blog post linked in an article (2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit, what percentage of employees recommend the company as a workplace? The company later that year offered a sign-on bonus for new hires.
...
```json
{
    "user_query": "Per the blog post linked in an article (2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit, what percentage of employees recommend the com"
}
```
