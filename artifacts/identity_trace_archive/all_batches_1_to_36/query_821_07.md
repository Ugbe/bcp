...
What percentage of employees recommend the company as a workplace, per the blog post linked from an article (2020-2023, updated 29 minutes later) reporting a lawsuit over a withdrawn job offer, with the company offering a sign-on bonus later that year?
...
```json
{
    "user_query": "What percentage of employees recommend the company as a workplace, per the blog post linked from an article (2020-2023, updated 29 minutes later) reporting a la"
}
```
