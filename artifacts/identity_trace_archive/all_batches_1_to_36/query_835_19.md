...
Narrow using the 1970-1990 formation window and the founder's 100M+-selling rock band tenure, then confirm with the teen professional debut, three marriages, one daughter and one son, art college, and boutique work to name the band.
...
```json
{
    "user_query": "Narrow using the 1970-1990 formation window and the founder's 100M+-selling rock band tenure, then confirm with the teen professional debut, three marriages, on"
}
```
