...
An article (2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit linked to a company blog post from the same day; later that year the company offered a sign-on bonus. According to the blog post, what percentage of employees recommend the company as a workplace?
...
```json
{
    "user_query": "An article (2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit linked to a company blog post from the same day; later that year the compan"
}
```
