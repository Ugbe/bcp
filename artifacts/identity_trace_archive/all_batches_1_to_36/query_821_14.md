...
Give the percentage of employees recommending the company as a workplace, per the blog post linked from an article (2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit, where the company offered a sign-on bonus later that year.
...
```json
{
    "user_query": "Give the percentage of employees recommending the company as a workplace, per the blog post linked from an article (2020-2023, updated 29 minutes later) about a"
}
```
