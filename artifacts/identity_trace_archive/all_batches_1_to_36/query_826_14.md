...
Name the only nonfiction work of the author born between 1930 and 1940 whose works focus on the magical aspects of literature, who pursued sciences at a government institution, served in the military during unrest, published a sci-fi book before 2020, had a pre-1970 debut novel that became a set text, and was once abducted and rescued hours later.
...
```json
{
    "user_query": "Name the only nonfiction work of the author born between 1930 and 1940 whose works focus on the magical aspects of literature, who pursued sciences at a governm"
}
```
