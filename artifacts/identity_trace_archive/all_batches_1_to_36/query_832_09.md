...
Pre-2023 international cup league decider: 4 total goals; 2-goal margin; 38 fouls; most goals in the first half (one penalty, one stoppage-time); match winner lost the aggregate by one goal. Name the aggregate-losing captain and their club's founding century.
...
```json
{
    "user_query": "Pre-2023 international cup league decider: 4 total goals; 2-goal margin; 38 fouls; most goals in the first half (one penalty, one stoppage-time); match winner l"
}
```
