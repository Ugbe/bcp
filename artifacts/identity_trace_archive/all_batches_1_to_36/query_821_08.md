...
According to the blog post linked in an article (published 2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit, what percentage of employees recommend the company as a workplace? The company offered a sign-on bonus later that year.
...
```json
{
    "user_query": "According to the blog post linked in an article (published 2020-2023, updated 29 minutes later) about a withdrawn-job-offer lawsuit, what percentage of employee"
}
```
