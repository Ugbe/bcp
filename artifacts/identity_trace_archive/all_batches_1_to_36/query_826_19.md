...
Narrow using the magical-literature focus and the abduction-and-rescue, then confirm with the government-institution science studies, military service during unrest, the sci-fi book before 2020, and the pre-1970 set-text first novel, to name the only nonfiction work.
...
```json
{
    "user_query": "Narrow using the magical-literature focus and the abduction-and-rescue, then confirm with the government-institution science studies, military service during un"
}
```
