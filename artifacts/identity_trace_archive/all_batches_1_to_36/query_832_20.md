...
Pinpoint the pre-2023 international cup league tie via the decider stats (4 goals, 2-goal margin, 38 fouls, first-half penalty and stoppage-time goal, match winner lost aggregate by one), then give the aggregate-losing captain and their club's founding century.
...
```json
{
    "user_query": "Pinpoint the pre-2023 international cup league tie via the decider stats (4 goals, 2-goal margin, 38 fouls, first-half penalty and stoppage-time goal, match win"
}
```
