...
According to the company blog post referenced in an article (published 2020-2023 and updated 29 minutes later) about an individual suing over a withdrawn job offer, what percentage of employees recommend the company as a workplace? Later that year the company offered a sign-on bonus.
...
```json
{
    "user_query": "According to the company blog post referenced in an article (published 2020-2023 and updated 29 minutes later) about an individual suing over a withdrawn job of"
}
```
