...
Name the only nonfiction work of an author (born between 1930 and 1940) known for the magical aspects of literature, who studied sciences at a government institution, served in the military during unrest, published a science fiction book before 2020, had a pre-1970 first novel become a set text, and was once captured and rescued hours later.
...
```json
{
    "user_query": "Name the only nonfiction work of an author (born between 1930 and 1940) known for the magical aspects of literature, who studied sciences at a government instit"
}
```
