...
Pinpoint the band via the 1970-1990 formation and the founder's profile (100M+-selling rock band, teen professional debut, three marriages, one daughter and one son, art college, boutique work), then name it.
...
```json
{
    "user_query": "Pinpoint the band via the 1970-1990 formation and the founder's profile (100M+-selling rock band, teen professional debut, three marriages, one daughter and one"
}
```
