...
Use the founder profile (100M+-selling rock band alumnus, teen professional debut, three marriages, one son and one daughter, art college, boutique work) and the 1970-1990 formation window to identify the band.
...
```json
{
    "user_query": "Use the founder profile (100M+-selling rock band alumnus, teen professional debut, three marriages, one son and one daughter, art college, boutique work) and th"
}
```
