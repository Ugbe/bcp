...
Played in a rock band that sold over 100 million records; began performing professionally as a teen; married three times; one daughter and one son; attended art college; worked in a boutique; formed a band between 1970 and 1990. Name the band.
...
```json
{
    "user_query": "Played in a rock band that sold over 100 million records; began performing professionally as a teen; married three times; one daughter and one son; attended art"
}
```
