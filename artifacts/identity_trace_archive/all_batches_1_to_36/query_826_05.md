...
What was the only nonfiction work published by an author (born 1930-1940) whose works explore the magical aspects of literature, who studied sciences at a government institution, served in the military during unrest, had a sci-fi book before 2020, saw a pre-1970 debut novel become a set text, and was once abducted and rescued within hours?
...
```json
{
    "user_query": "What was the only nonfiction work published by an author (born 1930-1940) whose works explore the magical aspects of literature, who studied sciences at a gover"
}
```
